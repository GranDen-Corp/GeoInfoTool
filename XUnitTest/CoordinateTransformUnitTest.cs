...
namespace XUnitTest
{
    public class CoordinateTransformUnitTest
    {
        ...
        [Fact]
        public void TestTransformToXyTupleStaticMethod()
        {
            //Arrange
            var referenceOrigin = new ReferenceOriginWgs84Point(new Wgs84Point { Lat = 25.0783615, Lon = 121.5750212 });
            var targetWgs84Point = new Wgs84Point
            ...
            //Act
            var transformedOrigin = Wgs84Transform.TransformToCartesianTuple(referenceOrigin, ref referenceOrigin);
            var transformedTarget = Wgs84Transform.TransformToCartesianTuple(targetWgs84Point, ref referenceOrigin);
        ...
        [Fact]
        public void TestTransformBackToWgs84TupleStaticMethod()
        {
            //Arrange
            var referenceOrigin = new ReferenceOriginWgs84Point(new Wgs84Point { Lat = 25.0783615, Lon = 121.5750212 });
            var referenceOriginCartesianPoint = new CartesianPoint {X = 0.0, Y = 0.0};
            var transformedTarget = new CartesianPoint { X = -10.8250645005394, Y = 254.80489950534 };
            var desiredWgs84Tuple = (Lat: 25.0806617, Lon: 121.5749139);
            const int precision = 7;
            ...
            var transBackedOrigin =
                Wgs84Transform.TransformBackToTuple(referenceOriginCartesianPoint, ref referenceOrigin);
            var transBackedWgs84Tuple = Wgs84Transform.TransformBackToTuple(transformedTarget, ref referenceOrigin);
